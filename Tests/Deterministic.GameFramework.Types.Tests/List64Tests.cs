...
public class List64Tests
{
    [Fact]
    public void Add_ShouldAddItem()
    {
        var list = new List64<int>();
        list.Add(10);
        list.Add(20);
    ...
    public void Add_OverCapacity_ShouldThrow()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => list.Add(64));
    }
    ...
    {
        var list1 = new List64<int>();
        list1.Add(1);
        list1.Add(2);

        var list2 = new List64<int>();
        list2.Add(1);
        list2.Add(2);
        
        var list3 = new List64<int>();
        list3.Add(1);
        list3.Add(3);
    ...
    {
        var list = new List64<int>();
        list.Count = 80; // Corrupt state
        
        // Index 70 is >= 0 and < Count (80), so it enters switch.
        // Switch only goes up to 63.
        // Should return default(int) which is 0.
        Assert.Equal(0, list[70]);
    }
}
