...
public class Dictionary32Tests
{
    [Fact]
    public void Add_ShouldAddItem()
    {
        var dict = new Dictionary32<int, int>();
        dict.Add(1, 10);
        dict.Add(2, 20);
    ...
    public void Add_OverCapacity_ShouldThrow()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => dict.Add(32, 320));
    }
    ...
    {
        var dict1 = new Dictionary32<int, int>();
        dict1.Add(1, 10);
        dict1.Add(2, 20);

        var dict2 = new Dictionary32<int, int>();
        dict2.Add(1, 10);
        dict2.Add(2, 20);
        
        var dict3 = new Dictionary32<int, int>();
        dict3.Add(1, 10);
        dict3.Add(2, 30); // Different value
        
        var dict4 = new Dictionary32<int, int>();
