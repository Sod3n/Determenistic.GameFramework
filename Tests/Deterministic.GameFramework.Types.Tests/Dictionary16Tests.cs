...
public class Dictionary16Tests
{
    [Fact]
    public void Add_ShouldAddItem()
    {
        var dict = new Dictionary16<int, int>();
        dict.Add(1, 10);
        dict.Add(2, 20);
    ...
    public void Add_OverCapacity_ShouldThrow()
    {
        ...
        Assert.Equal(16, dict.Count);
        Assert.Throws<InvalidOperationException>(() => dict.Add(16, 160));
    }
    ...
    {
        var dict1 = new Dictionary16<int, int>();
        dict1.Add(1, 10);
        dict1.Add(2, 20);

        var dict2 = new Dictionary16<int, int>();
        dict2.Add(1, 10);
        dict2.Add(2, 20);
        
        var dict3 = new Dictionary16<int, int>();
        dict3.Add(1, 10);
        dict3.Add(2, 30); // Different value
        
        var dict4 = new Dictionary16<int, int>();
