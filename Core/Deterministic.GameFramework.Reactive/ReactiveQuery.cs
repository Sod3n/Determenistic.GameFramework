    ...
    where T1 : struct, IComponent
{
    ...
    public readonly EntityWorld State;
    public readonly BitMask128 Mask;
    public readonly List<Func<Entity, bool>> Filters;

    public ReactiveQuery(ReactiveSystem system, EntityWorld state)
    {
        System = system;
        State = state;
        Mask = new BitMask128();
...
public static class ReactiveSystemQueryExtensions
{
    public static ReactiveQuery<T1> ObservableCollection<T1>(this ReactiveSystem system)
        where T1 : struct, IComponent
    {
        if (system.BoundState == null) throw new InvalidOperationException("ReactiveSystem must be bound to a EntityWorld to use ObservableCollection without explicit state.");
    ...
    public static ReactiveQuery<T1> ObservableCollection<T1>(this ReactiveSystem system, EntityWorld state)
        where T1 : struct, IComponent
    {
        return new ReactiveQuery<T1>(system, state);
    }

    public static ReactiveQuery<T1, T2> ObservableCollection<T1, T2>(this ReactiveSystem system, EntityWorld state)
        where T1 : struct, IComponent
        where T2 : struct, IComponent
    {
    ...
    public static ReactiveQuery<T1, T2, T3> ObservableCollection<T1, T2, T3>(this ReactiveSystem system, EntityWorld state)
        where T1 : struct, IComponent
        where T2 : struct, IComponent
        where T3 : struct, IComponent
    {
