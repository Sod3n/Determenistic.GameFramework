...
namespace Deterministic.GameFramework.Detour
{
    public static class DtDetour
    {
        ...
        public static readonly Float DT_RAY_CAST_LIMIT_PROPORTIONS = 50.0f;
        ...
        public static void CalcSlabEndPoints(Float[] verts, int va, int vb, ref DtVec2f bmin, ref DtVec2f bmax, int side)
        {
            if (side == 0 || side == 4)
            {
