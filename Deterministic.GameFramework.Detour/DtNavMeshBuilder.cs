...
namespace Deterministic.GameFramework.Detour
{
    ...
    public static class DtNavMeshBuilder
    {
        ...
        private static void CalcExtends(DtBVItem[] items, int nitems, int imin, int imax, ref DtVec3i bmin, ref DtVec3i bmax)
        {
        ...
        private static int CreateBVTree(DtNavMeshCreateParams option, DtBVNode[] nodes)
        {
            ...
            for (int i = 0; i < option.polyCount; i++)
            {
                ...
                else
                {
                    ...
                    // Remap y
                    it.bmin.Y = (int)Float.Floor((Float)it.bmin.Y * option.ch * quantFactor);
                    it.bmax.Y = (int)Float.Ceil((Float)it.bmax.Y * option.ch * quantFactor);
                }
            }
        ...
        public static DtMeshData CreateNavMeshData(DtNavMeshCreateParams option)
        {
            ...
            header.bvQuantFactor = (Float)1.0f / option.cs;
