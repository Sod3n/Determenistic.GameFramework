...
using static Deterministic.GameFramework.Box2D.B2DistanceJoints;
using static Deterministic.GameFramework.Box2D.B2MotorJoints;
using static Deterministic.GameFramework.Box2D.B2PrismaticJoints;
using static Deterministic.GameFramework.Box2D.B2RevoluteJoints;
using static Deterministic.GameFramework.Box2D.B2WeldJoints;
using static Deterministic.GameFramework.Box2D.B2WheelJoints;
        ...
        internal static void b2GetJointReaction(B2JointSim sim, float invTimeStep, out float force, out float torque)
        {
            ...
            switch (sim.type)
            {
                ...
                case B2JointType.b2_prismaticJoint:
                {
                    ...
                    linearImpulse = (float)Float.Sqrt(perpImpulse * perpImpulse + axialImpulse * axialImpulse);
        ...
        public static float b2Joint_GetLinearSeparation(B2JointId jointId)
        {
            ...
            switch (joint.type)
            {
                ...
                case B2JointType.b2_prismaticJoint:
                {
                    ...
                    return (float)Float.Sqrt(perpendicularSeparation * perpendicularSeparation + limitSeparation * limitSeparation);
                }
