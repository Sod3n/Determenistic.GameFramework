        ...
        internal static B2ShapeExtent b2ComputeShapeExtent(B2Shape shape, B2Vec2 localCenter)
        {
            ...
            switch (shape.type)
            {
                case B2ShapeType.b2_capsuleShape:
                {
                    ...
                    extent.maxExtent = (float)Float.Sqrt(b2MaxFloat(b2LengthSquared(c1), b2LengthSquared(c2))) + radius;
                }
                    break;
                ...
                case B2ShapeType.b2_polygonShape:
                {
                    ...
                    extent.maxExtent = (float)Float.Sqrt(maxExtentSqr) + poly.radius;
                }
                    break;
                ...
                case B2ShapeType.b2_segmentShape:
                {
                    ...
                    extent.maxExtent = (float)Float.Sqrt(b2MaxFloat(b2LengthSquared(c1), b2LengthSquared(c2)));
                }
                    break;
