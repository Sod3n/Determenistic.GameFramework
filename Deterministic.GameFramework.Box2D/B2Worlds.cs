...
using static Deterministic.GameFramework.Box2D.B2Arrays;
using static Deterministic.GameFramework.Box2D.B2DynamicTrees;
using static Deterministic.GameFramework.Box2D.B2Cores;
using static Deterministic.GameFramework.Box2D.B2Diagnostics;
using static Deterministic.GameFramework.Box2D.B2Buffers;
using static Deterministic.GameFramework.Box2D.B2Profiling;
using static Deterministic.GameFramework.Box2D.B2Constants;
using static Deterministic.GameFramework.Box2D.B2Contacts;
using static Deterministic.GameFramework.Box2D.B2MathFunction;
using static Deterministic.GameFramework.Box2D.B2Shapes;
using static Deterministic.GameFramework.Box2D.B2Solvers;
using static Deterministic.GameFramework.Box2D.B2Bodies;
using static Deterministic.GameFramework.Box2D.B2Joints;
using static Deterministic.GameFramework.Box2D.B2IdPools;
using static Deterministic.GameFramework.Box2D.B2ArenaAllocators;
using static Deterministic.GameFramework.Box2D.B2BoardPhases;
using static Deterministic.GameFramework.Box2D.B2Distances;
using static Deterministic.GameFramework.Box2D.B2ConstraintGraphs;
using static Deterministic.GameFramework.Box2D.B2BitSets;
using static Deterministic.GameFramework.Box2D.B2SolverSets;
using static Deterministic.GameFramework.Box2D.B2AABBs;
using static Deterministic.GameFramework.Box2D.B2CTZs;
using static Deterministic.GameFramework.Box2D.B2Islands;
using static Deterministic.GameFramework.Box2D.B2Timers;
using static Deterministic.GameFramework.Box2D.B2Sensors;
...
namespace Deterministic.GameFramework.Box2D
{
    public static class B2Worlds
    {
        ...
        internal static float b2DefaultFrictionCallback(float frictionA, ulong materialA, float frictionB, ulong materialB)
        {
            ...
            return (float)Float.Sqrt(frictionA * frictionB);
        }
