...
## 1. NetworkId Registry

To avoid slow reflection at startup, the framework generates a `NetworkIdRegistry` class at compile time.
...
This happens automatically when you add the `[NetworkId]` attribute.
