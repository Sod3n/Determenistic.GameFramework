...
public class NetworkActionHeaderTests
{
    ...
    public void NetworkActionHeader_ShouldSerializeAndDeserialize_Correctly()
    {
        ...
        deserialized.NetworkId.Should().Be(42);
    ...
    public void NetworkActionHeader_ShouldHandleZeroValues()
    {
        ...
        deserialized.NetworkId.Should().Be(0);
    ...
    public void NetworkActionHeader_ShouldHandleNegativeValues()
    {
        ...
        deserialized.NetworkId.Should().Be(-1);
    ...
    public void NetworkActionHeader_ShouldHandleMaxValues()
    {
        ...
        deserialized.NetworkId.Should().Be(int.MaxValue);
    ...
    public void NetworkActionHeader_MultipleHeaders_ShouldSerializeSequentially()
    {
        var headers = new[]
        {
            new NetworkActionHeader { NetworkId = 1, TargetEntityId = 10, ExecuteTick = 100L, DataLength = 5 },
            new NetworkActionHeader { NetworkId = 2, TargetEntityId = 20, ExecuteTick = 200L, DataLength = 10 },
            new NetworkActionHeader { NetworkId = 3, TargetEntityId = 30, ExecuteTick = 300L, DataLength = 15 }
        };
        ...
        for (int i = 0; i < headers.Length; i++)
        {
            ...
            deserialized.NetworkId.Should().Be(headers[i].NetworkId);
